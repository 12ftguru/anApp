...
class ExtDirect_Router {
        ...
        public function parseRequest() {
            if(isset($GLOBALS['HTTP_RAW_POST_DATA']) && preg_match('/{/', $GLOBALS['HTTP_RAW_POST_DATA'])){
                $this->data = json_decode($GLOBALS['HTTP_RAW_POST_DATA']);
            } else if(isset($GLOBALS['fakeData'])) {
	      $this->data = json_decode($GLOBALS['fakeData']);
